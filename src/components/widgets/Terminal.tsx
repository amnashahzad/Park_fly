...
import CheapParking from './CheapPaking';
  ...
  const handleTerminalClick = (terminalNumber: string) => {
    ...
    switch (terminalNumber) {
      ...
      case '5':
        ...
        setDescription('Terminal 5 is Heathrow Airports newest and biggest terminal. It is used exclusively for British Airways and Iberia flights. This terminal is likely to be very busy at all times, so you ill want to arrive in good time in advance to check in, go through security and catch your flight on time. For long-haul destinations outside of Europe, it is recommended to check in 3 hours in advance of your flight time. Taking your car to the airport means you ww not need to worry about transport delays on your way to the airport. There are many parking options available to suit all your needs, including Heathrow Meet and Greet, self-park and stay and fly. If you are considering park and fly, you can choose between different Heathrow airport hotels. They offer hotel and parking packages. Whichever option you choose, well find you the best deal available. Book Heathrow airport parking.');
        break;
      default:
        break;
    }
